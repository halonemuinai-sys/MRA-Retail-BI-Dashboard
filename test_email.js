...
function sendDailyEmailReport(targetDateStr) {
  try {
    ...
    <div style="font-family: Arial, sans-serif; color: #333; max-width: 800px; margin: 0 auto;">
      ...
      <table style="width: 100%; max-width: 500px; border-collapse: collapse; margin-bottom: 20px; font-size: 14px;">
        <tr style="background-color: #f3f4f6;">
          <th style="padding: 8px; border: 1px solid #ddd; text-align: left;">Location</th>
          <th style="padding: 8px; border: 1px solid #ddd; text-align: right;">Adjusted Performance</th>
        </tr>
        <tr>
